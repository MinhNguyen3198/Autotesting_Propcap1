...
WebUI.click(findTestObject('Object Repository/Page_PropCap/Avatar'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_PropCap/div_Logout_inAvatar'))

WebUI.delay(5)

ActualUrl = 'https://client-portal-dev.propcaptechnologieshk.com/login'
