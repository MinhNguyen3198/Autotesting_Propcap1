...
WebUI.setText(findTestObject('Object Repository/Page_PropCap/input_Login_login_email_inAP'), email)

WebUI.setText(findTestObject('Object Repository/Page_PropCap/input_Login_login_password_inAP'), password)
