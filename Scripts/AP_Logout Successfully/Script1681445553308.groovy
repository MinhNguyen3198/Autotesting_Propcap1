...
WebUI.click(findTestObject('Object Repository/Page_PropCap/div_Logout_inAP'))

WebUI.delay(5)

ActualUrl2 = 'https://admin-portal-dev.propcaptechnologieshk.com/login'

ExpectedUrl2 = WebUI.getUrl()

WebUI.verifyEqual(ActualUrl2, ExpectedUrl2)
